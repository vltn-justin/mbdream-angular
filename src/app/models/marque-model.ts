...
export class Convert {
  public static toMarqueModel(json: string): MarqueModel {
    return cast(JSON.parse(json), r('MarqueModel'));
  }

  public static marqueModelToJson(value: MarqueModel): string {
    return JSON.stringify(uncast(value, r('MarqueModel')), null, 2);
  }
}
...
const typeMap: any = {
  'MarqueModel': o([
    {json: 'idMarque', js: 'idMarque', typ: 0},
